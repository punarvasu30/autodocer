...
public class DocumentationParser {
        ...
        if (controllers.isEmpty()) {
            ...
            for (Object controllerBean : controllers.values()) {
                ...
                for (Method method : controllerClass.getDeclaredMethods()) {
                    // Pass the AI service down to the parseMethod
    ...
    private Optional<EndpointInfo> parseMethod(Method method, String basePath) {
        ...
        // ... (Finding httpMethod and path remains the same) ...
        ...
        // ... (fullPath calculation remains the same) ...
        ...
        // ... (parameterInfos parsing remains the same) ...
        ...
        List<String> paramContextStrings = parameterInfos.stream()
                .map(p -> String.format("%s %s %s",
                        p.sourceType(),
                        formatTypeForContext(p.type()), // Use new helper
                        p.name()))
        ...
        EndpointInfo endpointInfo = new EndpointInfo(
                ...
                parameterInfos,
                responseType,
                aiResult.summary(),       // <-- UPDATED
                aiResult.description()    // <-- UPDATED
        );
    ...
    private String formatTypeForContext(Object type) {
        ...
        if (type instanceof ArraySchemaInfo array) {
            // Recursively format the type inside the array
